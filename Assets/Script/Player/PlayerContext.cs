...
namespace Kamatte.Player
{
    public class PlayerContext    //  初期化用コンテキスト
    {
        ...
        public PlayerContext(PlayerHitBox hitBoxMgr, Transform headTF, StateReader_SwordCatch stateReader, StateWriter_SwordCatch stateWriter, AudioSource audioSource, AudioClip catchSE)
        {
            HitBoxMgr = hitBoxMgr;
            HeadTF = headTF;
